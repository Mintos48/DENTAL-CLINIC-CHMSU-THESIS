...
<body>
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group form-group-full">
                                <div class="checkbox-group">
                                    ...
                                    <label class="checkbox-label">
                                        <input type="checkbox" id="edit-receive-sms-reminders" name="receive_sms_reminders">
                                        <span class="checkbox-text">
                                            <i class="fas fa-sms"></i> SMS appointment reminders
                                        </span>
                                    </label>
                                </div>
                            </div>
    ...
    <script>
        class ProfileManager {
            ...
            updateProfileStats() {
                // This would typically fetch appointment statistics
            ...
            populateEditForm() {
                ...
                document.getElementById('edit-receive-sms-reminders').checked = profile.receive_sms_reminders !== 0;
            }
            ...
            saveProfile(event) {
                ...
                const profileData = {
                    ...
                    receive_sms_reminders: formData.get('receive_sms_reminders') === 'on' ? 1 : 0
                };
...
- SMS Reminders: ${profile.receive_sms_reminders ? 'Enabled' : 'Disabled'}
