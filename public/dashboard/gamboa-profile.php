...
// Get branch ID for Gamboa Dental Clinic (ID = 3)
$branch_id = 3;
        ...
        <section class="specialty-section">
            ...
            <div class="specialty-grid">
                <div class="specialty-item">
                    ...
                    <div class="specialty-name">Preventive Dentistry</div>
                    <div class="specialty-desc">Regular check-ups, cleanings, and preventive care to maintain oral health</div>
                </div>
                ...
                <div class="specialty-item">
                    ...
                    <div class="specialty-name">Restorative Dentistry</div>
                    <div class="specialty-desc">Fillings, crowns, bridges, and dentures to restore dental function</div>
                </div>
                ...
                <div class="specialty-item">
                    ...
                    <div class="specialty-desc">Tooth extractions, wisdom teeth removal, and minor surgical procedures</div>
                </div>
                ...
                <div class="specialty-item">
                    ...
                    <div class="specialty-desc">Gentle, compassionate care for children's dental needs</div>
                </div>
            </div>
        </section>
            ...
            <div class="services-grid">
                <?php if (!empty($clinicData['services'])): ?>
                    <?php foreach (array_slice($clinicData['services'], 0, 6) as $service): ?>
                        <div class="service-card">
                            ...
                            <p class="service-desc"><?php echo htmlspecialchars($service['description'] ?? 'Professional dental care service for the whole family.'); ?></p>
                ...
                <?php else: ?>
                    ...
                    <div class="service-card">
                        ...
                        <p class="service-price">Starting at ₱500.00</p>
                    </div>
                    ...
                    <div class="service-card">
                        ...
                        <h4 class="service-title">Tooth Fillings</h4>
                        <p class="service-desc">Quality composite and amalgam fillings to restore decayed or damaged teeth.</p>
                        <p class="service-price">Starting at ₱800.00</p>
                    </div>
                    ...
                    <div class="service-card">
                        ...
                        <h4 class="service-title">Tooth Extraction</h4>
                        <p class="service-desc">Safe and painless tooth extraction procedures including wisdom teeth removal.</p>
                        <p class="service-price">Starting at ₱1,000.00</p>
                    </div>
                    ...
                    <div class="service-card">
                        ...
                        <p class="service-price">Family packages available</p>
                    </div>
                    ...
                    <div class="service-card">
                        ...
                        <h4 class="service-title">Dentures & Crowns</h4>
                        <p class="service-desc">Custom-fitted dentures and dental crowns for tooth replacement and restoration.</p>
                        <p class="service-price">Starting at ₱3,500.00</p>
                    </div>
