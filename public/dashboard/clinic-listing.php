        ...
        <div class="nav-container">
            ...
            <div class="user-section">
                ...
                <div class="dropdown-menu" id="dropdownMenu">
                    <a href="patient-dashboard.php" class="dropdown-item">
                        ...
                        <div class="clinic-info">
                            ...
                            <div class="clinic-rating">
                                <div class="stars">
                                    ...
                                    <span><?php echo $clinic['rating']; ?></span>
                                </div>
                                <span class="rating-text">(<?php echo $clinic['review_count']; ?> reviews)</span>
                            </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            notificationIcons.forEach(icon => {
                icon.addEventListener('click', function() {
                    const iconType = this.querySelector('i').classList.contains('fa-envelope') ? 'Messages' : 'Notifications';
                    alert(`${iconType} clicked`);
                    
                    // You can implement notification functionality here
                    // window.location.href = iconType === 'Messages' ? 'messages.php' : 'notifications.php';
                });
            });
