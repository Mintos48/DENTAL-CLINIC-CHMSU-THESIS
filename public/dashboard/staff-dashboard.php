...
<body class="modern-dashboard">
            ...
            <aside class="dashboard-sidebar">
                ...
                <div class="sidebar-section">
                    ...
                    <div class="quick-actions">
                        ...
                        <a href="#" class="quick-action" onclick="exportAppointments()">
                            <div class="action-icon">
                                <i class="fas fa-download"></i>
                            </div>
                            <div class="action-text">Export Data</div>
                        </a>
                        <a href="#" class="quick-action" onclick="printAppointments()">
                            <div class="action-icon">
    ...
    <script>
        ...
        function exportAppointments() {
            console.log('exportAppointments called');
        }
        function printAppointments() {
            console.log('printAppointments called');
        }
        ...
        function displayPendingAppointments(appointments) {
            ...
            appointments.forEach(function (appt, index) {
                ...
                // Notes
                html += '<td style="max-width: 200px; overflow: hidden; text-overflow: ellipsis;">' + (appt.notes || '-') + '</td>';
        ...
        function displayAllAppointments(appointments) {
            ...
            appointments.forEach(function (appt) {
                ...
                // Time  
                html += '<td style="color: #054A91; font-weight: 600;">' + appt.appointment_time + '</td>';
                ...
                if (appt.status === 'pending') {
                    ...
                    html += '<button class="btn-modern btn-primary" onclick="markCompleted(' + appt.id + ')" title="Mark as completed">';
                    html += '<i class="fas fa-check-double"></i></button>';
                    html += '<button class="btn-modern btn-warning" onclick="referAppointment(' + appt.id + ')" title="Refer">';
                    html += '<i class="fas fa-exchange-alt"></i></button>';
                }
        ...
        function populateEditForm(appointment) {
            ...
            if (isWalkIn) {
                ...
                if (patientNameLabel) {
                    patientNameLabel.innerHTML = 'Patient Name <span class="text-danger">*</span>';
                }
            } else {
                // Regular appointment - disable name editing with explanation
                patientNameField.disabled = true;
                patientNameField.style.backgroundColor = '#f8f9fa';
                if (patientNameLabel) {
                    patientNameLabel.innerHTML = 'Patient Name <small class="text-muted">(Read-only for registered users)</small>';
                }
            }
        ...
        function exportToCSV() {
            const csvContent = generateCSVContent(allAppointments);
        ...
        function generateCSVContent(appointments) {
            const headers = ['Patient Name', 'Date', 'Time', 'Status', 'Notes', 'Created'];
        ...
        function displayIncomingReferrals(referrals) {
            ...
            referrals.forEach(referral => {
                ...
                // From Branch
                html += '<td style="font-weight: 500;">' + safeBranchName + '</td>';
        ...
        function displaySentReferrals(referrals) {
            ...
            referrals.forEach(referral => {
                ...
                // Date (Created)
                html += '<td style="font-weight: 500;">' + (referral.created_at ? new Date(referral.created_at).toLocaleDateString() : 'Unknown') + '</td>';
    ...
    <div id="appointment-modal" class="modal" style="display: none;">
        <div class="modal-content">
            ...
            <div
                ...
                <div>
                    <label style="font-weight: 600; color: #374151;">Patient Name:</label>
                    <p id="modal-patient-name" style="margin: 8px 0 16px 0; font-size: 16px;"></p>
                </div>
                <div>
                    <label style="font-weight: 600; color: #374151;">Date:</label>
                    <p id="modal-appointment-date" style="margin: 8px 0 16px 0; font-size: 16px;"></p>
                </div>
                <div>
                    <label style="font-weight: 600; color: #374151;">Time:</label>
                    <p id="modal-appointment-time" style="margin: 8px 0 16px 0; font-size: 16px;"></p>
                </div>
                <div>
                    <label style="font-weight: 600; color: #374151;">Status:</label>
                    <p id="modal-status" style="margin: 8px 0 16px 0; font-size: 16px;"></p>
                </div>
                <div style="grid-column: 1 / -1;">
                    <label style="font-weight: 600; color: #374151;">Notes:</label>
                    <p id="modal-notes"
                        style="margin: 8px 0 16px 0; font-size: 16px; background: #f8fafc; padding: 12px; border-radius: 8px;">
                    </p>
                </div>
                <div>
                    <label style="font-weight: 600; color: #374151;">Created:</label>
                    <p id="modal-created" style="margin: 8px 0 16px 0; font-size: 16px;"></p>
                </div>
            </div>
        </div>
    </div>
